    ...
    if ($action === 'run') {
        try {
            ...
            $migrations = [
                ...
                // Add created_at to emails so Leads Manager can order/export by date
                "ALTER TABLE `emails` ADD COLUMN `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP",
                ...
                // send_logs: drop strict FK so logs survive campaign deletion; add user_id for direct ownership
                ...
                // Ensure backup_emails table exists for upgrades
